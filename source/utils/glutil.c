...
void gl_init() {
    // Il gioco disegna la UI in modo incrementale, assumendo che il framebuffer
    // persista fra un frame e l'altro (comportamento comune su Android con
    // EGL_BUFFER_PRESERVED). vitaGL usa 3 buffer a rotazione, quindi quel
    // disegno finisce su buffer diversi e la UI lampeggia/sparisce.
